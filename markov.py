...
def inputLines(filename: str):
    """Yields all the lines in a file one by one"""
...
if __name__ == '__main__':
    if not os.path.exists('markov.pickle'):
        progGen = pyprind.prog_bar(inputLines('movies.list'), iterations = 3598943, title = 'processing input file')
